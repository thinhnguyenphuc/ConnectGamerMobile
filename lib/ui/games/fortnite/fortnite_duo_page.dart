...
class FortniteDuoPage extends StatefulWidget {
  const FortniteDuoPage({Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _FortniteDuoPageState();
}

class _FortniteDuoPageState extends State<FortniteDuoPage> with StateVariablesMixin, FortniteSuperClass{
  @override
          ...
          child: Container(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  String value =
                  getAttribute(profile!.stats.duo, index);
                  return Visibility(
                      visible: value != "-1",
